...
class Event < ActiveRecord::Base
  ...
  has_many :attendees, :through => :event_attendees, :source => :person, :select => "event_attendees.origin, event_attendees.distance, event_attendees.carbon, people.*"
  ...
  def attend(person, location="", distance="", carbon="")
    self.event_attendees.create!(:person => person, :origin => location, :distance => distance, :carbon => carbon)
